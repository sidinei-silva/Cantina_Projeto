...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { descricaoProduto: @produto.descricaoProduto, imagemProduto: @produto.imagemProduto, precoProduto: @produto.precoProduto, statusProduto: @produto.statusProduto } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { descricaoProduto: @produto.descricaoProduto, imagemProduto: @produto.imagemProduto, precoProduto: @produto.precoProduto, statusProduto: @produto.statusProduto } }
